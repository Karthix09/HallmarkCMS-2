...
const PatientAddEdit = (props) => {
      ...
      PatientService.fetchPatientById(id)
        .then((res) => {
          ...
          if (Array.isArray(res.data.patientMedicalHistories)) {
            console.log("in medicalHistoryArray")
            console.log(res.data.patientMedicalHistories);
          ...
          if (Array.isArray(res.data.patientMedicalGroups)) {
            ...
            res.data.patientMedicalGroups.map((item) => {
              ...
              console.log("medGroup array")
              console.log(medicalGroupArray)
            });
    ...
    if (selectedMedicalHistory !== null) {
      selectedMedicalHistory.map((option) => {
        ...
        if (objIndex === -1) {
          ...
          historyObject.medicalHistoryDesc = option.lookupValue;
    ...
    if (selectedMedicalGroup !== null) {
      selectedMedicalGroup.map((option) => {
        ...
        if (objIndex === -1) {
          ...
          groupObject.groupDesc = option.lookupValue;
  ...
  const submitForm = (e) => {
    ...
    console.log("before submitstate")
    ...
    if (mode === MasterData.pageMode.Add) {
      ...
      console.log("submitState in patient update")
      console.log(submitState)
