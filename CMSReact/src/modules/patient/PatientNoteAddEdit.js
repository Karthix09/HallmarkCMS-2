...
const PatientNoteAddEdit = (props) => {
  ...
  useEffect(() => {
    if (isMainDataLoading && mode === MasterData.pageMode.Edit) {
        ...
        console.log("in fetchPatientClinicalNotesById")
        console.log( res.data)
        console.log("idParam" + idParam)
        setPatientNoteInfo(res.data);
        setUserName(res.data.userName);
        const patNotes = Array.isArray(res.data) ? res.data : [];
        ...
        dispatch({
          field: "clinicalNote",
          value: res.data[0].clinicalNote
        });
        dispatch({
          field: "noteDate",
          value: res.data[0].noteDate
        });
        dispatch({
          field: "noteCreatedBy",
          value: res.data[0].noteCreatedBy
        });
        dispatch({
          field: "id",
          value: res.data[0].id
        ...
        dispatch({
          ...
          value: Helper.getFormattedDate(
            res.data[0].followupAppointmentDate,
            "YYYY-MM-DD"
          ),
        });
  ...
  const submitForm = (e) => {
    ...
    if (mode === "ADD") {
      ...
      // console.log("in update clinical notes")
      // console.log(submitState.id);
