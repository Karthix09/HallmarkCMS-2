...
import setOpenNotification from "../../../modules/patient/PatientProfile"
...
const ProcedureAddEdit = (props) => {
  ...
  const handleProcedureDelete = () => {
    setOpen(false);
    deleteProcedure(props.match.params.procedureId);
    console.log(props.match.params)
  };

  const deleteProcedure = (id) => {
    console.log(id)
    MasterService.deleteProcedure(id)
      .then((response) => {
  ...
  return (
    <>
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Procedure Delete"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            You are about to delete {procedureName}. Do you wish
            to go ahead?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          ...
          <Button onClick={handleProcedureDelete} color="primary" autoFocus>
            Yes
          </Button>
        </DialogActions>
      </Dialog>
      <NotificationDialog
        ...
        title="Patients"
      >
        <span>Procedure deleted successfully !!!</span>
      </NotificationDialog>
    </>
  );
};
