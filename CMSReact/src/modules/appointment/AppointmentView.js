				...
				<div style={{ margin: "1px" }}>
					...
					<div
						...
						{waitingTime !== "" ? (
							<>
								<span>
									{props.resource?.appointmentStatus === "CON" ? (//Here-------------------------
								...
								<span>
									{props.resource?.appointmentStatus === "CON" ? ( // Changed----------------------c
										<span>
											<Button
					...
					{copied && !issuperAdmin ? (
						...
						<>
							<div style={{ textAlign: "right", paddingTop: "8px", border: "0px solid" }}>
								{props.resource?.appointmentStatus === "CAN" || props.resource?.checkinTime === null ? ( // CHECK HERE---------------------------------------
